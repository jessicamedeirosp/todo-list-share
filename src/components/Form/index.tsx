...
export function Form({id}: FormProps) {
    const { todos, todoCurrent, createTodo, updateTodo, readTodo, readTodos, setModal, toggleModal } = useTodo()
    ...
    return (
        <FormContainer onSubmit={handleSubmit}>
            <div className="content-flex-between">
                ...
                {id && <button onClick={handleCreate} className="btn-add content-flex">Criar Item <AiOutlinePlus /></button>}
            </div>
